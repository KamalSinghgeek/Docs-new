...
<Head>
  ...
  <title>Fleet Stack Installation and GPS Integration Guide</title>
  <meta name="description" content="Install and configure Fleet Stack for fleet management. Follow our step-by-step guide for a smooth setup and GPS device integration." />
  <meta name="keywords" content="Fleet Stack installation, GPS integration, fleet management software, server setup, GPS tracking, Fleet Stack guide, software configuration" />
  <meta name="author" content="Fleet Stack Team" />
  <meta name="robots" content="index, follow" />
  <link rel="canonical" href="https://docs.fleetstackglobal.com/guides/Software-Installation/installation/" />
  
  <!-- Open Graph Metadata for social sharing -->
  <meta property="og:title" content="Fleet Stack Installation and GPS Integration Guide" />
  <meta property="og:description" content="Install and configure Fleet Stack for fleet management. Follow our step-by-step guide for a smooth setup and GPS device integration." />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://docs.fleetstackglobal.com/guides/Software-Installation/installation/" />
  <meta property="og:image" content="https://fleetstackglobal.com/assets/img/Graphics/orginal/Stack01.png" />
  
  <!-- Twitter Card Metadata -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Fleet Stack Installation and GPS Integration Guide" />
  <meta name="twitter:description" content="Install and configure Fleet Stack for fleet management. Follow our step-by-step guide for a smooth setup and GPS device integration." />
  ...
  {`
      {
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://docs.fleetstackglobal.com/guides/Software-Installation/"
        },
        "headline": "Fleet Stack Installation and GPS Integration Guide",
        "description": "Install and configure Fleet Stack for fleet management. Follow our step-by-step guide for a smooth setup and GPS device integration.",
...
2. **Access Fleet Stack**:
   - Open **Google Chrome** or **Microsoft Edge** and navigate to `http://localhost`.
