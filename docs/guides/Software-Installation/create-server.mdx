...
<Head>
  ...
  <title>Create Cloud Server - Fleet Stack Guide</title>
  <meta name="description" content="Learn how to build a secure, scalable, and robust cloud server on AWS with Fleet Stack. Follow our step-by-step guide to configure your instance like a pro." />
  <meta name="keywords" content="Cloud server, AWS, Fleet Stack, server setup, cloud computing, EC2, AWS instance, cloud deployment, server configuration" />
  <meta name="author" content="Fleet Stack Team" />
  <meta name="robots" content="index, follow" />
  <link rel="canonical" href="https://docs.fleetstackglobal.com/guides/Software-Installation/create-server/" />
  
  <!-- Open Graph Metadata for social sharing -->
  <meta property="og:title" content="Create Cloud Server - Fleet Stack Guide" />
  <meta property="og:description" content="Learn how to build a secure, scalable, and robust cloud server on AWS with Fleet Stack. Follow our step-by-step guide to configure your instance like a pro." />
  <meta property="og:type" content="article" />
  <meta property="og:url" content="https://docs.fleetstackglobal.com/guides/Software-Installation/create-server/" />
  <meta property="og:image" content="https://fleetstackglobal.com/assets/img/Graphics/orginal/Stack01.png" />
  
  <!-- Twitter Card Metadata -->
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Create Cloud Server - Fleet Stack Guide" />
  <meta name="twitter:description" content="Learn how to build a secure, scalable, and robust cloud server on AWS with Fleet Stack." />
  ...
  {`
      {
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://docs.fleetstackglobal.com/guides/Software-Installation/create-server/"
        },
        "headline": "Create Cloud Server - Fleet Stack Guide",
        "description": "Learn how to build a secure, scalable, and robust cloud server on AWS with Fleet Stack. Follow our step-by-step guide to configure your instance like a pro.",
